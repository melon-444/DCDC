...
static const uint8_t *font5x7(char c)
{
    ...
    static const uint8_t J[5] = {0b10,0b10000001,0b11111110,0b10000000,0b0};//handimake
    static const uint8_t K[5] = {0xFF,0b00100000,0b01010000,0b10001111,0b0};//handimake
    ...
    static const uint8_t Q[5] = {0x7F,0x09,0x09,0x09,0x06};//handimake
